    ...
    <body>
                    ...
                    <div class="col-sm-8 login-section mt-5 mb-5 shadow">
                        <div class="row">
                            ...
                            <div class="col-sm-6 right-section">
                                ...
                                <form id="accounts-login-form" class="mt-5 text-center">
                                    <div class="mb-3">
                                        <!-- <label for="email" class="form-label">Email address</label> -->
                                        <input type="text" class="form-control" name="accounts_email" id="accounts_email" placeholder="Email Address">
                                    </div>
                                    <div class="mb-3">
                                        <!-- <label for="password" class="form-label">Password</label> -->
                                        <input type="password" class="form-control" name="accounts_password" id="accounts_password" placeholder="Password">
                                    </div>
                                    <div class="mb-3">
        ...
        <script>
            $(document).ready(function () {
                ...
                $('#accounts-login-form').on('submit', function (e) {
                    e.preventDefault();

                    let accounts_email = $('#accounts_email').val().trim();
                    let accounts_password = $('#accounts_password').val().trim();
                    ...
                    if (!emailPattern.test(accounts_email)) {
                    ...
                    $.ajax({
                        ...
                        type: 'POST',
                        data: { accounts_email: accounts_email, accounts_password: accounts_password },
